// Colors
export const colorPrimary = 'seagreen';
export const colorPrimaryAlt = 'rgb(33, 107, 65)';
export const colorSecondary = 'snow';
export const colorSecondaryAlt = 'rgb(245, 241, 241)';
export const colorBodyText = '#333';
